...
Head of the department of cse
 <h2> Click Here to stock in lab</h2>
 <pre><form action="addstock.php" ><button type="submit" name="add" value="add item" style="font-size:30px; text-align:left; font-family: 'Lobster', sans-serif; margin-left:600px;">display</button></form>